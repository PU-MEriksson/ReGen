        ...
        <div class="hero">
            <div class="content">
                <div class="text-container">
                    <div class="text">UPPLEV<br>
                        FRAMTIDEN<br>
                        I BACKEN</div>
                    <div class="text">Kliv in i snösportens nya<br>
                        värld, där säkerhet och miljö<br>
                        går hand i hand.</div>
                </div>
                <div class="button-container">
                    <button class="explore">Utforska kollektion <svg width="24" height="25" viewBox="0 0 24 25" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <button class="tech">Läs om tekniken <svg width="24" height="25" viewBox="0 0 24 25" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <g id="icon/arrow_right_alt">
